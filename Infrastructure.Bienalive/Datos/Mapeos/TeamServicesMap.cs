namespace Infrastructure.Bienalive.Datos.Mapeos
{
    ...
    public class TeamServicesMap : IEntityTypeConfiguration<TeamServices>
    {
        #region Métodos
        ...
        public void Configure(EntityTypeBuilder<TeamServices> builder)
        {
            builder.HasKey(e => e.Id);

            builder.ToTable("teamservices", "dbo");
        }
