namespace Infrastructure.Bienalive.Extenciones
{
    ...
    public class ApplicationLifetimeEventsHostedService : IHostedService
    {
        ...
        {
            Console.WriteLine("MS de Bienalive iniciado", "information_source");
        }

        /// <summary>Método que se ejecuta cuando la aplicación se está deteniendo.</summary>
        private void OnStopping()
        {
            Console.WriteLine("Ms de Bienalive se está deteniendo", "warning");
            Thread.Sleep(10000);
        }
        ...
        {
            Console.WriteLine("Ms de Bienalive detenida", "warning");
            Thread.Sleep(10000);
        }
